<?php
class Application_Model_Championship extends My_Model
{
    protected $_name = 'championships'; //table name
    ...
    public function buildDataGrid() {
        ...
        $this->dataGrid->setGridId('championship');
        ...
        $this->dataGrid->updateColumn('Description',array(
                            'title'		=> 'Description',
                            'decorator' => '<a href="/championship/detail/id/{{ID}}">{{Description}}</a>',
                            'position'  => 10,
        ));    
