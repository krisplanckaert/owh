...
class Application_Form_Team extends My_Form
{
    ...
    {
        $this->_defaultFormOptions['action'] = '/team/detail'; //@todo: build action automatic, based on application and controller
